...
const Projects = () => {
  ...
  return (
    <div className="min-h-screen  w-screen flex flex-row justify-around gap-x-2" id="projectsbox">
      <div className="w-1/3  h-full flex flex-wrap gap-y-12" id="left">
        {BackEndProjects.map((bp, index) => (
          ...
          >
            ...
            <div className="flex flex-col mt-4 w-full">
              ...
              <div className="flex flex-row flex-wrap gap-1 w-f justify-around">
                {bp.techs.map((tech, techIndex) => (
                  <div key={techIndex} className="flex justify-center items-center pt-2">
                    {tech}
                  </div>
                ))}
              </div>
      ...
      <div className="w-1/3  h-screen flex flex-col justify-around items-center" id="middle">
        <div className="flex-grow flex flex-col justify-center items-center space-y-2">
          <h1 className="uppercase text-2xl text-center">Front-end projects</h1>
          <FaArrowRight size={50} color="#00ff00" />
        </div>
        <div className="flex-grow flex flex-col justify-center items-center space-y-2">
          <FaArrowLeft size={50} color="#00ff00" />
          <h1 className="uppercase text-2xl text-center">Back-end projects</h1>
        </div>
      </div>
      <div className="w-1/3  h-full flex flex-wrap gap-y-12" id="right">
